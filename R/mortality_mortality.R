...
#' @param N, the number of individuals alive in the census 1 per category selected
#' @param D, the number of individuals no longer alive in census 2
#' @param rate, the mean annualized mortality rate constant per category selected, calculated as (log(N)-log(S))/time 
#' @param upper, upper confidence limit of mean rate
#' @param lower, lower confidence limit of mean rate
