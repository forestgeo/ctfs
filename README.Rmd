...
A files collectoin in `R/` (not an R package _sensu stricto_), that is the source code of the original CTFS R Package (Richard Condit). The files were extracted from their original folders and renamed to preserve their folder source with the format `<FOLDERNAME>_<FILENAME>.R`.
