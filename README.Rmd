...
This package provides tools for the analysis of forest dynamics. It evolves from the source code of the CTFS R Package by Richard Condit, available at [http://ctfs.si.edu/Public/CTFSRPackage/](http://ctfs.si.edu/Public/CTFSRPackage/).
