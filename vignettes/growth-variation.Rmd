...
censuses <- list(dat_bci12full1, dat_bci12full7)
...
Choose any diameter category, and any . 

Here is an example for big trees at BCI (dbh ≥ 400), with all seven censuses included.
