...
err004 <- "Errs because density.ind uses subset"
...
solved_with <- tibble::tribble(
  ...
  "biomass.CTFSdb", err004, "remove subset (non-standard evaluation)"
...
errs <- tribble(
  ...
  # "Biomass", "biomass.CTFSdb", xxx,
  # "Biomass", "Chave.AGB", xxx,
  # "Growth vs. DBH",
  # "ImageJ",
  # "Plot maps",
  # "Topography",
...
errs
left_join(errs, solved_with) %>% filter(errs)
```
