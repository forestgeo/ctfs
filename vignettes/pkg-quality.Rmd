...
One way of measuring the quality of a package is its complexity. To measure the complexity of the forestr package, and to compare it to other packages, we will use the sig package. Best practice is to keep a package simple (_Testing R code_ by Richard Cotton).

## _forestr_

This reports the complexity of forestr:
